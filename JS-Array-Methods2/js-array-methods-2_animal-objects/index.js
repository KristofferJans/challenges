...
console.log(
  `The weight of all animals in Africa is ${weightOfAllAnimalsInAfrica}kg `
);
...
console.log(
  `The average weight of the animals in Africa is ${averageWeightOfAllAnimalsInAfrica}kg `
);
