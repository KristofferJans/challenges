...
const secondProductTeaser = `
  <article class="product">
    <div class="product__body">
        <div class="product__text-container">
          <h2 class="product__name">${name2}</h2>
...
document.body.innerHTML += secondProductTeaser;

const secondProduct = document.querySelector(".product:last-child");
const buyButton = secondProduct.querySelector(".product__buy-button");

buyButton.addEventListener("click", () => {
  console.log(`Produktname: ${name2}`);
