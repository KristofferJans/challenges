...
// EXERCISE 7
// Write a function reverseArrayWithoutMutating that takes an array as an argument and returns a new array
...
export const reverseArr = reverseArrayWithoutMutating(arr);
console.log(reverseArr); // Should log [3, 2, 1] without altering arr
console.log(arr); // Should still log [1, 2, 3]

// EXERCISE 8
// Develop a function mergeAndSortArrays that takes two arrays of numbers as arguments and returns a new array
// that is the result of merging the two arrays and sorting the elements in ascending order.
...
export const mergedAndSorted = mergeAndSortArrays(array1, array2);
