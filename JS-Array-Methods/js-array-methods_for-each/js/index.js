...
In the `./js/index.js` file, there is an array `colors` containing some hex codes. 
Create colored boxes from the array of hex codes using the `forEach` array method.
...
//   colorHEX.classList.add("color-box");
//   colorHEX.style.backgroundColor = color;

//   document.body.append(colorHEX);
// });
